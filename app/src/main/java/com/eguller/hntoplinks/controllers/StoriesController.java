...
public class StoriesController {
  ...
  @GetMapping("/today")
  public String today(Model model, @RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "sort", defaultValue = "upvotes") SortType sort) {
  ...
  @GetMapping("/week")
  public String week(Model model, @RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "sort", defaultValue = "upvotes") SortType sort) {
  ...
  @GetMapping("/month")
  public String month(Model model, @RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "sort", defaultValue = "upvotes") SortType sort) {
  ...
  @GetMapping("/year")
  public String year(Model model, @RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "sort", defaultValue = "upvotes") SortType sort) {
    var interval = DateUtils.getIntervalForToday();
    var items = itemRepository.findByInterval(interval, sort, PAGE_SIZE, page);
    var storiesContent = StoriesContent.builder()
      .stories(items)
  ...
  @GetMapping("/all")
  public String all(Model model, @RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "sort", defaultValue = "upvotes") SortType sort) {
  ...
  public String byDay(
    Model model, @PathVariable("year") int year,
