...
public class UAgentInfo {
  ...
  public static final String deviceBB10Touch    = "touch";
  ...
  public boolean detectBlackBerry() {
    if (userAgent.indexOf(deviceBB) != -1 ||
      httpAccept.indexOf(vndRIM) != -1 || userAgent.indexOf(deviceBB10) != -1) {
      return true;
    }
    return false;
  }
  ...
  public boolean detectBlackBerryTouch() {
    if (detectBlackBerry() &&
      (userAgent.indexOf(deviceBBStorm) != -1 ||
        ...
        userAgent.indexOf(deviceBB10Touch) != -1)) {
      return true;
    }
    return false;
  }
